...
with_node \
  ...
  --target "/Users/dmitrijkeller/Documents/XCodeProj/sector/mobile/ios/Pods/Target Support Files/Pods-SectorGram/ExpoModulesProvider.swift" \
  --entitlement "/Users/dmitrijkeller/Documents/XCodeProj/sector/mobile/ios/SectorGram/SectorGram.entitlements" \
   \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-audio" "expo-camera" "expo-constants" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-notifications" "expo-video"
